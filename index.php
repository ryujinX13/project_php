...
<body>
    ...
    <header class="header">
        <h1>บริการพาผู้สูงอายุไปหาหมอ</h1>
    ...
    <div class="content-section">
        <div class="about-section">
            <img src="img/p3.png" alt="เกี่ยวกับเรา">
            <div class="text-content">
                <h3>เกี่ยวกับเรา</h3>
                <p>ศูนย์ดูแลผู้สูงอายุหรือผู้ป่วยในระยะพักฟื้นรูปแบบใหม่ มุ่งเน้นการออกแบบ และวางแผนการดูแลสุขภาพเฉพาะบุคคล (Personalized Wellness Solution) ในทุกๆ ด้านตามหลักการ การแพทย์องค์รวม และเวชศาสตร์ชะลอวัย (Holistic care & Anti-aging) เพื่อพัฒนาส่งเสริมสุขภาพของผู้เข้าพัก และชะลอความเสื่อมของร่างกาย</p>
                <a href="#" class="btn">บริการของเรา</a>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 service-item">
                        ...
                        <h3>เข้ารับฟังแพทย์ชี้แจงแนวทางรักษาร่วมกับคนไข้</h3>
                        <p>(แล้วแต่กรณี ต้องได้รับอนุญาตจากคนไข้และแพทย์ก่อน)</p>
                    </div>
                    <div class="col-md-4 service-item">
        ...
        <div class="service-area-section">
            ...
            <img src="img/p3.png" alt="พื้นที่ให้บริการในจังหวัดขอนแก่น">
        </div>
        ...
        <div class="travel-fee-section">
            ...
            <img src="img/p3.png" alt="ค่าเดินทางรับส่งคนไข้คิดตามระยะทาง">
        </div>
    </div>
